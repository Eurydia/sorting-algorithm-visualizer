...
import { radixSort, FrameState } from "./helper";
...
type RendererRadixSortProps = {
	dataset: number[];
	heightPx: number;
};
export const RendererRadixSort: FC<
	RendererRadixSortProps
> = (props) => {
